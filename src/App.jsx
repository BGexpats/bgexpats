...
import momaImg from "./assets/moma.webp"
            ...
            return(
              <div key={i} style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:14,overflow:"hidden",boxShadow:"0 2px 8px rgba(0,0,0,0.05)"}}>
                ...
                <div style={{padding:"14px 16px"}}>
                  ...
                  {place.url&&<a href={place.url} target="_blank" rel="noopener noreferrer" style={{display:"inline-block",marginTop:10,fontSize:13,fontWeight:600,color:C.primary,textDecoration:"underline"}}>Visit website →</a>}
                </div>
              </div>
            )
          })}
    ...
    cities: [
      { id:"varna-city", name:"Varna Center", tagline:"Sea Garden, beach & city life", hero:varnaHeroImg,
        ...
        places:[
          ...
          {name:"Dolphinarium",type:"attraction",desc:"Inside the Sea Garden — dolphin shows that remain one of Varna's most popular family attractions.",img:"",area:"Sea Garden"},
          {name:"Roman Thermae",type:"attraction",desc:"The remains of the largest Roman baths in Bulgaria, right in the city centre — substantial ruins you can walk through.",img:"",area:"Center"},
      ...
      { id:"burgas-city", name:"Burgas Center", tagline:"Lakes, beach and a relaxed vibe", hero:"https://images.unsplash.com/photo-1683653417751-ea68aa8bc289?w=1200&q=80",
        ...
        places:[
          ...
          {name:"La Ferme",type:"restaurant",desc:"Well-regarded Burgas restaurant that regularly appears in coastal best-of lists. Good for a special dinner.",img:"",area:"Center"},
          {name:"BM Fish",type:"restaurant",desc:"Fresh Black Sea fish and seafood — the local choice when you want the catch rather than the grill.",img:"",area:"Center"},
          {name:"Ethno Restaurant",type:"restaurant",desc:"Traditional Bulgarian food in a folk-styled setting, with live music some evenings.",img:"",area:"Center"},
          {name:"Neptun",type:"restaurant",desc:"Long-running seafood spot near the water, popular with families and locals alike.",img:"",area:"Sea Garden"},
          {name:"Coffee & Co",type:"cafe",desc:"Specialty coffee on the pedestrian Aleko Bogoridi street — a good base for watching the town go by.",img:"",area:"Bogoridi St"},
          {name:"Cafe Aroma",type:"cafe",desc:"Relaxed central café for coffee and cake, a short walk from the Sea Garden.",img:"",area:"Center"},
          {name:"Sea Garden cafés",type:"cafe",desc:"The park's terraces are lined with cafés looking out over the water — the most pleasant place in Burgas for a slow afternoon coffee.",img:"",area:"Sea Garden"},
          {name:"Bar Gramofon",type:"bar",desc:"Central Burgas bar with a music-led atmosphere and a loyal local following.",img:"",area:"Center"},
          {name:"Cargo Bar",type:"bar",desc:"Popular evening spot in the centre — cocktails, a young crowd and a lively weekend scene.",img:"",area:"Center"},
          {name:"Beach bars, Burgas Beach",type:"bar",desc:"A string of open-air bars along the city beach below the Sea Garden. Best in the evening as the temperature drops.",img:"",area:"Beach"},
          {name:"Aleko Bogoridi Street",type:"attraction",desc:"The pedestrian main artery — cafés, shops, galleries and the town's evening promenade. Everything in central Burgas runs off it.",img:"",area:"Bogoridi St"},
          {name:"Burgas Sea Garden",type:"attraction",desc:"A vast park running the length of the coast, with spectacular views, sculpture, and paths down to the beach. The best of Burgas.",img:"",area:"Sea Garden"},
          {name:"Burgas Lakes & Poda Nature Reserve",type:"attraction",desc:"Burgas sits between three lakes on a major bird migration route — one of Europe's best birdwatching spots, with hides and a visitor centre at Poda.",img:"",area:"Lakes"},
          {name:"Regional Historical Museum",type:"attraction",desc:"Thracian and Greek finds from the surrounding coast, including material from nearby Apollonia (Sozopol).",img:"",area:"Center"},
          {name:"Burgas Central Beach",type:"beach",desc:"Wide city beach a 10-minute walk from the centre, backed by the Sea Garden. Quieter than the resort beaches north and south.",img:"",area:"Beach"},
        ]},
      { id:"nessebar", name:"Nessebar", tagline:"UNESCO old town on a peninsula", hero:nessebar,
        intro:"A 3,000-year-old town on a narrow peninsula, connected to the mainland by a man-made isthmus. The entire old town is UNESCO-listed and packed with medieval churches, cobbled lanes and seafood restaurants. Sunny Beach is 5km away for nightlife.",
        places:[
          {name:"La Vista Restaurant",type:"restaurant",desc:"One of the highest-ranked restaurants on the Bulgarian coast, with views to match the cooking.",img:"",area:"Old Town"},
          {name:"Old Nessebar seafood taverns",type:"restaurant",desc:"The lanes of the old town are lined with fish restaurants — Greek influence runs strong here, so expect fresh fish, seafood and big salads.",img:"",area:"Old Town"},
          {name:"Nessebar Old Town",type:"attraction",desc:"UNESCO World Heritage site said to hold as many as 40 Orthodox churches. Cobbled streets, Byzantine fortifications and wooden Revival houses.",img:"",area:"Old Town"},
          {name:"Church of St Stephen",type:"attraction",desc:"11th-century church housing hundreds of mural paintings and a richly decorated altarpiece — the best-preserved of Nessebar's churches.",img:"",area:"Old Town"},
          {name:"Church of St Sofia",type:"attraction",desc:"Ruins of the 5th-century basilica, with stone columns and tall arched windows open to the sky.",img:"",area:"Old Town"},
          {name:"Nessebar Archaeological Museum",type:"attraction",desc:"Covers the town's Thracian, Greek and Byzantine past — useful context before walking the old town.",img:"",area:"Old Town"},
          {name:"Nessebar South Beach",type:"beach",desc:"Shallow, calm water that makes this one of the better coastal spots for young children.",img:"",area:"New Town"},
        ]},
      { id:"sunny-beach", name:"Sunny Beach", tagline:"Bulgaria's biggest party resort", hero:sunnyBeachImg,
        intro:"The country's largest purpose-built resort — hundreds of bars, restaurants and clubs along a long sandy beach. Loud, cheap and unapologetically a party destination. Nessebar's old town is 5km away when you want the opposite.",
        places:[
          {name:"Za Zú Lounge & Restaurant",type:"restaurant",desc:"One of the better dining rooms in the resort, a step up from the strip's fast food.",img:"",area:"Resort"},
          {name:"Amara Sugar",type:"restaurant",desc:"Well-regarded restaurant that features in coastal best-of lists — worth booking.",img:"",area:"Resort"},
          {name:"Galeon Dine and Wine",type:"restaurant",desc:"Dining and wine on the Sunny Beach strip, at the more serious end of the resort's offering.",img:"",area:"Resort"},
          {name:"The Strip",type:"club",desc:"The main resort artery — beach clubs and open-air bars running late into the night through summer. Nightlife here is the reason most people come.",img:"",area:"Resort"},
          {name:"Aqua Paradise Water Park",type:"attraction",desc:"Large water park just outside the resort — the standard family day out on this stretch of coast.",img:"",area:"Resort"},
          {name:"Sunny Beach",type:"beach",desc:"Several kilometres of wide sand with every water sport on offer. Busy in July and August; far calmer in June and September.",img:"",area:"Resort"},
        ]},
      { id:"sozopol", name:"Sozopol", tagline:"Bohemian old town south of Burgas", hero:sozopolImg,
        intro:"Founded in the 7th century BC as Apollonia, Sozopol has a historic quarter of wooden houses, art galleries and a bohemian atmosphere. Livelier and more authentic in the evening than Nessebar, with beach bars and live music. The Apollonia Festival each summer fills the town with concerts and exhibitions.",
        places:[
          {name:"Antique Well",type:"restaurant",desc:"One of the top-ranked restaurants on the coast, in the heart of the old town.",img:"",area:"Old Town"},
          {name:"Cavo",type:"restaurant",desc:"Highly rated Sozopol restaurant — a reliable choice for a good dinner in season.",img:"",area:"Old Town"},
          {name:"Urania",type:"restaurant",desc:"Another of Sozopol's better dining rooms, regularly listed among the coast's best.",img:"",area:"Old Town"},
          {name:"Old Town beach bars",type:"bar",desc:"Sozopol wins on authentic nightlife — beach bars and live music venues rather than mega-clubs, with a crowd that's more local than package tourist.",img:"",area:"Old Town"},
          {name:"Sozopol Old Town",type:"attraction",desc:"Wooden Revival houses, narrow lanes, galleries and Greek ruins on a small peninsula. Quieter and more lived-in than Nessebar.",img:"",area:"Old Town"},
          {name:"Apollonia Festival",type:"attraction",desc:"Held every summer, turning the town into a cultural hotspot with art exhibitions, concerts and theatre.",img:"",area:"Old Town"},
          {name:"Sozopol Central Beach",type:"beach",desc:"Sandy city beach with sunbeds, clear water and several beach bars. Small but there's room for everyone.",img:"",area:"Center"},
        ]},
      { id:"sveti-vlas", name:"Sveti Vlas", tagline:"Marina, calmer resort north of Sunny Beach", hero:svetivlasImg,
        intro:"A quieter resort just north of Sunny Beach, built around Bulgaria's largest marina and backed by the Balkan foothills. Popular with families and second-home owners who want the coast without the noise.",
        places:[
          {name:"PEPÈ by the sea",type:"restaurant",desc:"One of the highest-ranked restaurants on the Bulgarian coast — seaside dining at the serious end.",img:"",area:"Marina"},
          {name:"Onyx Beach Restaurant",type:"restaurant",desc:"Beachfront dining that regularly features in coastal top-twenty lists.",img:"",area:"Beach"},
          {name:"Levant Beach",type:"restaurant",desc:"Well-regarded beach restaurant, good for a long lunch by the water.",img:"",area:"Beach"},
          {name:"Marina Dinevi",type:"attraction",desc:"Bulgaria's largest marina — yachts, waterfront bars and restaurants, and the centre of the town's evening life.",img:"",area:"Marina"},
          {name:"Sveti Vlas Beach",type:"beach",desc:"Calmer sand than neighbouring Sunny Beach, with the mountains behind. Better for families.",img:"",area:"Beach"},
        ]},
    ],
  },
  ...
  "sofia": {
    ...
    cities: [
      { id:"sofia-center", name:"Sofia Center", tagline:"Embassies, cafés, nightlife", hero:"https://images.unsplash.com/photo-1753529179550-c6aff1b76e6e?w=1200&q=80",
        intro:"The heart of Sofia — compact, walkable and layered with Roman ruins, Orthodox churches and communist-era landmarks. Good restaurants, a strong specialty-coffee scene and most of the city's nightlife all sit within a few streets of each other. Locals eat around 8–9pm, hit a bar around 10pm, and don't reach the clubs until midnight.",
        places:[
          // ── Restaurants ──
          {name:"Moma Bulgarian Food & Wine",type:"restaurant",desc:"Traditional Bulgarian cuisine in a restored 1930s house, with rooms themed around Bulgarian folklore and costume. Roast lamb, kapama, kavarma and stuffed peppers served in a modern way, plus a summer courtyard. Book ahead at weekends. Solunska 28.",img:momaImg,url:"https://moma-restaurant.com/en/",area:"Center"},
          {name:"Cosmos",type:"restaurant",desc:"One of Sofia's best-known gourmet restaurants — Bulgarian flavours through modern technique, with seasonal 6–8 course tasting menus. Mon–Fri 12:00–22:30, Sat–Sun 11:00–22:30. Lavele 19.",img:cosmosImg,url:"https://cosmosbg.com/en/",area:"Center"},
          {name:"Shtastlivetsa",type:"restaurant",desc:"Long-running Bulgarian restaurant on the main pedestrian boulevard. Traditional dishes in a modern setting — a reliable, central choice. Vitosha Blvd.",img:shtastlivecaImg,url:"https://www.shtastliveca.com/",area:"Vitosha Blvd"},
          {name:"Manastirska Magernitsa",type:"restaurant",desc:"Authentic Bulgarian cooking in a charming stone-and-timber setting, with an unusually long menu of monastery-inspired recipes — lamb casserole, beef chomlek, rabbit in white wine and hot banitsa. Popular with visitors wanting the traditional experience.",img:magernitsaImg,url:"https://magernitsa.com/en/english/",area:"Center"},
          {name:"Hadjidraganov's Cellars",type:"restaurant",desc:"Bulgarian food with live folk music in a cellar-style interior of timber beams, wine barrels and woven textiles — a full cultural evening rather than just dinner. Hristo Belchev 18.",img:izbiteImg,url:"https://izbite.com/en/",area:"Center"},
          {name:"Happy Bar & Grill (Rakovski)",type:"restaurant",desc:"The homegrown Bulgarian chain most visitors end up at. Huge menu — sushi, burgers, pasta, Bulgarian classics — English-speaking staff and photo menus. Family-friendly. Around €12–18 per person. Book ahead Fri/Sat.",img:"",area:"Rakovski St"},
          // ── Cafés ──
          {name:"Coffee Syndicate",type:"cafe",desc:"Recently named Bulgaria's best specialty coffee by European Coffee Trip. Inventive drinks like rosemary espresso tonic, industrial-minimalist space that works well for laptops. Shipka St 5.",img:"",area:"Center"},
          {name:"Dabov Specialty Coffee",type:"cafe",desc:"Bulgaria's premier roaster, supplying over 100 local shops. Own blends, single origins and one-to-one cupping masterclasses. Marin Drinov 23.",img:"",area:"Center"},
          {name:"Chucky's Coffee House",type:"cafe",desc:"Sofia's first craft coffee store — knowledgeable English-speaking staff, beans and equipment to take home, plus a focus on training and education.",img:"",area:"Center"},
          {name:"Barista Coffee and More",type:"cafe",desc:"A favourite with digital nomads and students. Communal tables, sofa seating, sockets everywhere and fast wifi. Can get noisy at peak times. Vitosha Blvd 16.",img:"",area:"Vitosha Blvd"},
          {name:"Drekka",type:"cafe",desc:"Third-wave café and concept store in Oborishte, just north of the centre. Sky-blue minimalist design, house-roasted beans and a rotating monthly guest roaster.",img:"",area:"Oborishte"},
          {name:"Rainbow Factory",type:"cafe",desc:"Award-winning brunch spot known for traditional Bulgarian breakfasts, specialty coffee and cakes. Small space beside a tram line.",img:"",area:"Center"},
          // ── Bars ──
          {name:"Bar Me",type:"bar",desc:"Cosy cocktail bar in the old centre, known for its Bloody Mary. Five minutes' walk from Alexander Nevsky Cathedral — a good place to start an evening. Tsar Osvoboditel 7.",img:"",area:"Old Center"},
          {name:"One More Bar",type:"bar",desc:"Long-standing favourite in the centre, popular with both locals and expats. Good cocktails, relaxed crowd.",img:"",area:"Center"},
          {name:"Hambara",type:"bar",desc:"Candle-lit, barn-style hidden bar with no sign on the door — one of Sofia's most atmospheric drinking spots.",img:"",area:"Center"},
          {name:"5L Speakeasy",type:"bar",desc:"1920s-inspired speakeasy in the centre. Intimate, cocktail-focused, and part of the classic Sofia bar route.",img:"",area:"Center"},
          {name:"Bar Petuk",type:"bar",desc:"Well-known central bar on the local circuit — the sort of place Sofians go rather than tourists.",img:"",area:"Center"},
          {name:"Gravity Bar",type:"bar",desc:"Lively bar in the old city centre with a strong local following and a consistently busy weekend crowd.",img:"",area:"Old Center"},
          // ── Clubs ──
          {name:"Yalta",type:"club",desc:"Sofia's best-known house and techno club, running since the 1990s. Relaxed door policy, serious music programming. Doesn't fill until after midnight.",img:"",area:"Center"},
          {name:"Sofia Live Club",type:"club",desc:"Jazz, R&B and live music venue inside the National Palace of Culture complex — the place for a night built around a performance.",img:"",area:"NDK"},
          {name:"Terminal 1",type:"club",desc:"Indie and alternative club in the centre, drawing a younger, music-led crowd.",img:"",area:"Center"},
          {name:"Stroeja",type:"club",desc:"Rock and alternative club — loud, unpretentious and a long-time fixture of the Sofia scene.",img:"",area:"Center"},
          {name:"Sugar",type:"club",desc:"Hip-hop club with a smart-casual dress code. One of the busier mainstream options at weekends.",img:"",area:"Center"},
          {name:"Carrusel",type:"club",desc:"House club in the centre, popular on Friday and Saturday nights when the city's clubs come alive after midnight.",img:"",area:"Center"},
          // ── Attractions ──
          {name:"Alexander Nevsky Cathedral",type:"attraction",desc:"The vast Neo-Byzantine cathedral that defines Sofia's skyline, built in gratitude to the Russian liberators of 1878. Free to enter; the crypt museum has an icon collection.",img:"",area:"Center"},
          {name:"Rotunda Church of St George",type:"attraction",desc:"Sofia's oldest surviving building — 4th-century red brick, originally a Roman bathhouse, now tucked inside a courtyard behind the Presidential Palace.",img:"",area:"Center"},
          {name:"Basilica of St Sofia",type:"attraction",desc:"The church that gave the city its name, with an underground museum showing earlier churches and a Roman-era necropolis.",img:"",area:"Center"},
          {name:"National Archaeological Museum",type:"attraction",desc:"Housed in a 15th-century former mosque, the oldest surviving Ottoman-era building in the city. Thracian gold, Roman finds and medieval Bulgarian art.",img:"",area:"Center"},
          {name:"Ivan Vazov National Theatre",type:"attraction",desc:"Founded in 1904 and the oldest theatre in Bulgaria. Worth seeing for the neoclassical facade and the small park in front, even without a ticket.",img:"",area:"City Garden"},
          {name:"National Palace of Culture (NDK)",type:"attraction",desc:"Bulgaria's largest congress and events centre, a landmark of socialist-era architecture. Concerts, festivals and exhibitions year-round.",img:"",area:"NDK"},
          {name:"The Red Flat",type:"attraction",desc:"A recreated 1980s Sofia apartment you explore at your own pace — the best short introduction to daily life under communism.",img:"",area:"Center"},
          {name:"Tsentralni Hali (Central Market Hall)",type:"attraction",desc:"Neo-Renaissance market hall from 1911, reopened in 2024. Bakeries, delis and Bulgarian produce under an elegant arched roof.",img:"",area:"Center"},
          {name:"Vitosha Boulevard",type:"attraction",desc:"Sofia's main pedestrian street — shops, cafés and restaurants with Vitosha mountain framed at the end of it. Busy, central, and the easiest place to start.",img:"",area:"Vitosha Blvd"},
        ]},
    ],
  },
  "plovdiv": {
    ...
    cities: [
      { id:"plovdiv-old-town", name:"Old Town", tagline:"Cobblestones & Roman ruins", hero:plovdiv,
        ...
        places:[
          {name:"Pavaj",type:"restaurant",desc:"Kapana favourite serving modern Bulgarian dishes in a relaxed, quirky setting. Popular with locals, so book or arrive early in summer.",img:"",area:"Kapana"},
          {name:"Hemingway",type:"restaurant",desc:"Long-standing choice just off the main pedestrian street for a classier dinner — international menu, attentive service, smart interior.",img:"",area:"Center"},
          {name:"Rahat Tepe",type:"restaurant",desc:"Traditional Bulgarian mehana with a terrace and city views. Grilled meats, salads and local wine.",img:"",area:"Old Town"},
          {name:"Dayana Fish",type:"restaurant",desc:"Well-regarded fish and seafood restaurant — a change of pace from the grill-heavy menus elsewhere in the city.",img:"",area:"Center"},
          {name:"Diana",type:"restaurant",desc:"Authentic Bulgarian restaurant known among locals for shkembe chorba (tripe soup) — traditionally eaten in the early hours after a night out.",img:"",area:"Center"},
          {name:"Da Freddy",type:"restaurant",desc:"Small Italian kitchen in Kapana. Chef Freddy cooks genuine Italian dishes with authentic ingredients — a local favourite for pasta.",img:"",area:"Kapana"},
          {name:"Central Perk",type:"cafe",desc:"Friends-themed café in the heart of Kapana, with retro couch seating and an upper terrace that's ideal at sunset. Good for coffee, working online or an evening beer.",img:"",area:"Kapana"},
          {name:"Kotka i Mishka (Cat & Mouse)",type:"cafe",desc:"Craft beer bar and café in Kapana with a big selection of Bulgarian craft brews. Outdoor tables and a relaxed daytime feel that shifts into the evening.",img:"",area:"Kapana"},
          {name:"Bar Craft",type:"cafe",desc:"Craft beer spot in Kapana, one of the district's best-loved places for a slow beer in the night air.",img:"",area:"Kapana"},
          {name:"Monkey House",type:"cafe",desc:"Specialty coffee in central Plovdiv — a reliable daytime stop between Old Town sightseeing and Kapana.",img:"",area:"Center"},
          {name:"Art Club Nylon",type:"bar",desc:"A Kapana institution for over two decades. Eclectic dive-bar charm and a crowd that mixes bohemians, locals and curious visitors.",img:"",area:"Kapana"},
          {name:"Petnoto na Rorschach",type:"bar",desc:"Cosy little Kapana bar with jazz on the stereo, strong cocktails and bartenders who make the room. Small, so it fills quickly.",img:"",area:"Kapana"},
          {name:"Barber & Cat Bar",type:"bar",desc:"Creative cocktail bar in Kapana with a warm, cosy interior — a good spot to start or end an evening.",img:"",area:"Kapana"},
          {name:"Temple Bar",type:"bar",desc:"Popular central bar with a wide drinks list and a lively, social atmosphere.",img:"",area:"Center"},
          {name:"Judge O'Neills Pub",type:"bar",desc:"Irish pub near the centre — food, draught beer and a livelier crowd, handy if you want something familiar.",img:"",area:"Center"},
          {name:"Gatsby Piano Bar",type:"bar",desc:"Live music and a stylish setting — piano bar atmosphere rather than a club, good for a longer sit-down evening.",img:"",area:"Center"},
          {name:"Fabric",type:"club",desc:"Central Plovdiv nightlife spot on Otets Paisiy — busy at weekends and one of the go-to places once the bars wind down.",img:"",area:"Center"},
          {name:"Under City — Bar Rock Spirit",type:"club",desc:"Rock and alternative venue for music lovers, with a loud, unpretentious crowd.",img:"",area:"Center"},
          {name:"Roman Theatre of Philippopolis",type:"attraction",desc:"One of the best-preserved Roman theatres anywhere, still used for concerts and opera in summer. The single most impressive sight in the city.",img:"",area:"Old Town"},
          {name:"Kapana Creative District",type:"attraction",desc:"The former craftsmen's quarter, now Bulgaria's best bar-crawl district — galleries, craft beer, street art and dense outdoor seating. The name means 'the trap'.",img:"",area:"Kapana"},
          {name:"Plovdiv Old Town",type:"attraction",desc:"Cobbled streets and restored National Revival houses on the hill, several open as museums. Wear proper shoes — the cobbles are punishing.",img:"",area:"Old Town"},
          {name:"Ancient Stadium of Philippopolis",type:"attraction",desc:"Roman stadium remains visible beneath the main pedestrian street — you can see a section through glass in the middle of the shopping area.",img:"",area:"Center"},
          {name:"Tsar Simeon Garden",type:"attraction",desc:"The central park, with the singing fountains in the evening. Lovely by day and just as good after dark.",img:"",area:"Center"},
          {name:"Nebet Tepe",type:"attraction",desc:"Ancient hilltop ruins at the top of the Old Town, and the best free viewpoint over Plovdiv — especially at sunset.",img:"",area:"Old Town"},
          {name:"Knyaz Alexander I Street",type:"attraction",desc:"The long pedestrian main street, lined with cafés, shops and snack bars. The city's daytime spine.",img:"",area:"Center"},
        ]},
    ],
  },
  "varna": {
...
const PLACE_TYPES = {
  ...
  cafe:       { label: "Café",        color: "#7c5c2e", bg: "#f5ecd9" },
